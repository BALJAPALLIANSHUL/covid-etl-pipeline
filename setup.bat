...
REM Use the 'py' launcher to ensure the correct Python version is used for setup.
py -3 -V >nul 2>&1
IF %ERRORLEVEL% NEQ 0 (
...
ECHO Using 'py -3' launcher for initial setup.
...
REM Use 'python' directly to ensure the script runs within the activated virtual environment.
python etl.py
